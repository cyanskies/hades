...
namespace hades
{
	...
	template<typename ...Components>
	inline void basic_level_editor<Components...>::_component_on_drag_start(const brush_index_t i, const std::optional<terrain_target> p)
	{
	...
	template<typename ...Components>
	inline void basic_level_editor<Components...>::_component_on_drag(const brush_index_t i, const std::optional<terrain_target> p)
	{
	...
	template<typename ...Components>
	inline void basic_level_editor<Components...>::_component_on_drag_end(const brush_index_t i, const std::optional<terrain_target> p)
	{
	...
	template<typename ...Components>
	inline void basic_level_editor<Components...>::_generate_brush_preview(const brush_index_t brush_index, const time_duration dt, const std::optional<terrain_target> world_position)
	{
