...
namespace hades
{
	...
	{
		//create terrain_settings first
		//so that tile settings has the correct type

		//create empty_terrainset(same id as empty tileset)

		//register tile resources

		//register terrains
		//register tilesets with a terrainset parser
		//register terrainsets
	}
