...
namespace hades::state_api
{
	...
	object_ref make_object(const object_instance& o, game_state& s, extra_state& e)
	{
		assert(o.obj_type);
	...
	object_ref get_object_ref(std::string_view s, game_state& g, extra_state& e) noexcept
	{
	...
	game_obj* get_object(object_ref o, extra_state& e) noexcept
	{
		if (o.ptr == nullptr)
		{
