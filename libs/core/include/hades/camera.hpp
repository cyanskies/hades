...
{
	constexpr float calculate_width(const float static_height, const float width, const float height) noexcept
	{
	...
	void move(sf::View&, vector2_float move, rect_int clamp_region) noexcept;
}
