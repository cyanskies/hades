...
namespace hades::zip
{
	...
	template<>
	class basic_in_compressed_filebuf<char, std::char_traits<char>> : public std::basic_streambuf<char, std::char_traits<char>>
	{
	public:
	...
	static_assert(std::is_move_constructible_v<in_compressed_filebuf>);
	...
	// we only support basic char
	template<>
	class basic_out_compressed_filebuf<char, std::char_traits<char>> : public std::basic_streambuf<char, std::char_traits<char>>
	{
	public:
